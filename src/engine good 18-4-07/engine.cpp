...
__declspec( dllexport ) _stdcall process(D3DVECTOR *cam, D3DVECTOR *tri, long numtri, D3DVECTOR *pos, D3DVECTOR *pos2, D3DVECTOR *upv, double distance, double angle, double angleh, float disfromcol, float interpolationspeed, float midh, float hih, float avrframe, float speed, float dimensions, long *tris)
{
